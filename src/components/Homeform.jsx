...
import { Avatar, Textarea, Text, Button, Modal, Card, Col } from "@nextui-org/react";
      ...
      <div className="h-screen w-screen flex justify-center items-center ">
        <div className="max-w-5xl w-full h-full flex flex-col m-auto">
          <div className=" w-full  grid grid-cols-3 md:gap-4 gap-0 items-center my-3 p-2 ">
            ...
            <div className="">
              <dir>
                ...
                <Text h1 className="md:text-[1.3rem] text-[0.8rem]  border-2 md:ml-5 ml-2"
            ...
            <div className="flex flex-col justify-center items-end md:p-2">
              ...
              <div className="w-full flex justify-end items-end mb-2">
                ...
                <Button auto className="text-purple-600 border-solid border-purple-300 border-[1px] px-2
                                        hover:bg-purple-400 hover:text-white " onClick={handler}>
                  Edit Profile
                </Button>
          ...
          <div className="w-full max-w-lg h-full max-h-lg">
            <Modal closeButton blur aria-labelledby="modal-title" open={cardOpen} onClose={closeCard} width="60%"
            >
              <Modal.Body>
                <div className="w-full h-full flex flex-row">
                  <div className="w-[60%] border-2 flex flex-col pt-2">
                  </div>
          ...
          <div className="w-full max-w-lg h-full max-h-lg">
            <Modal closeButton blur aria-labelledby="modal-title" open={visible} onClose={closeHandler} width="100%"
            >
              <Modal.Body>
                <div className="w-full h-full flex flex-row">
